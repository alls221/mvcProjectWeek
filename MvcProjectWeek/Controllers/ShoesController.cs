...
namespace MvcProjectWeek.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoesId,Nickname,Type,Color,Season,Occasion,Photo")] Shoes shoes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoesId,Nickname,Type,Color,Season,Occasion,Photo")] Shoes shoes)
        {
            if (ModelState.IsValid)
            {
