...
namespace MvcProjectWeek.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopsId,Nickname,Type,Color,Season,Occasion,Photo")] Tops tops)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopsId,Nickname,Type,Color,Season,Occasion,Photo")] Tops tops)
        {
            if (ModelState.IsValid)
            {
